    ...
    def hipaa(base = default)
      base.customize do |c|
        c.transaction_set.customize do |x|
          ...
          x.register("005010", "HB", "271") { Stupidedi::Versions::FunctionalGroups::FiftyTen::TransactionSetDefs::HB271 }
          ...
          x.register("005010X279",   "HB", "271") { Stupidedi::Guides::FiftyTen::X279::FA999  }
        end
      end
    end
