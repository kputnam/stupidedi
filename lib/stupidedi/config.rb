    ...
    def hipaa(base = default)
      base.customize do |c|
        c.transaction_set.customize do |x|
          ...
          x.register("005010X222",   "HC", "837") { Stupidedi::TransactionSets::FiftyTen::Implementations::X222::HC837P }
          x.register("005010X223",   "HC", "837") { Stupidedi::TransactionSets::FiftyTen::Implementations::X223::HC837I }
          ...
          x.register("005010X222A1", "HC", "837") { Stupidedi::TransactionSets::FiftyTen::Implementations::X222A1::HC837P }
