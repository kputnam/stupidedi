      ...
      module FiftyTen
        module TransactionSetDefs
          ...
          autoload :HS270, # Eligibility, Coverage or Benefit Inquiry
            "stupidedi/dictionaries/functional_groups/005010/transaction_set_defs/HS270"

          # 005010X203
          # 005010X279 Eligibility, Coverage or Benefit Response
          autoload :HB271, # Eligibility, Coverage or Benefit Response
            "stupidedi/dictionaries/functional_groups/005010/transaction_set_defs/HB271"
          ...
          autoload :HR276, # Health Care Claim Status Request
            "stupidedi/dictionaries/functional_groups/005010/transaction_set_defs/HR276"
          ...
          autoload :HN277, # Health Care Information Status Notification
            "stupidedi/dictionaries/functional_groups/005010/transaction_set_defs/HN277"
          ...
          autoload :HI278, # Health Care Services Review Information
            "stupidedi/dictionaries/functional_groups/005010/transaction_set_defs/HI278"

          # 005010X218 Payment Order/Remittance Advice
          autoload :RA820, # Payment Order/Remittance Advice
            "stupidedi/dictionaries/functional_groups/005010/transaction_set_defs/RA820"

          # 005010X220 Benefit Enrollment and Maintenance
          autoload :BE834, # Benefit Enrollment and Maintenance
            "stupidedi/dictionaries/functional_groups/005010/transaction_set_defs/BE834"

          # 005010X221 Health Care Claim Payment/Advice
          autoload :HP835, # Health Care Claim Payment/Advice
            "stupidedi/dictionaries/functional_groups/005010/transaction_set_defs/HP835"
          ...
          autoload :HC837, # Health Care Claim
            "stupidedi/dictionaries/functional_groups/005010/transaction_set_defs/HC837"

          # 005010X230 Functional Acknowledgement
          autoload :FA997, # Functional Acknowledgment
            "stupidedi/dictionaries/functional_groups/005010/transaction_set_defs/FA997"

          # 005010X231 Functional Acknowledgement
          autoload :FA999, # Implementation Acknowledgment
            "stupidedi/dictionaries/functional_groups/005010/transaction_set_defs/FA999"
