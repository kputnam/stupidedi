        ...
        HC837 = v::ImplementationGuide.build(t::HC837,
          ...
          d::TableDef.build("Table 2 - Patient Detail",
            d::LoopDef.build("2000 PATIENT HIERARCHICAL LEVEL", d::RepeatCount.unbounded,
              segment(s:: HL.use( 10, r::Situational, d::RepeatCount.bounded(1)),
              segment(s::PAT.use( 70, r::Required, d::RepeatCount.bounded(1)),

              d::LoopDef.build("2010CA PATIENT NAME", d::RepeatCount.bounded(1),
                segment(s::NM1.use(150, r::Required, d::RepeatCount.bounded(1)),
                segment(s:: N3.use(250, r::Required, d::RepeatCount.bounded(1)),
                segment(s:: N4.use(300, r::Required, d::RepeatCount.bounded(1)),
                segment(s::DMG.use(320, r::Required, d::RepeatCount.bounded(1)),
                segment(s::REF.use(350, r::Situational, d::RepeatCount.bounded(1)),
                segment(s::PER.use(400, r::Situational, d::RepeatCount.bounded(1))),

              d::LoopDef.build("2300 CLAIM INFORMATION", d::RepeatCount.bounded(100),
                segment(s::CLM.use(1300, r::Required, d::RepeatCount.bounded(1)),
                segment(s::DTP.use(1350, r::Situational, d::RepeatCount.bounded(1)),
                segment(s::DTP.use(1350, r::Situational, d::RepeatCount.bounded(1)),
                segment(s::DTP.use(1350, r::Situational, d::RepeatCount.bounded(1)),
                segment(s::DTP.use(1350, r::Situational, d::RepeatCount.bounded(1)),
                segment(s::DTP.use(1350, r::Situational, d::RepeatCount.bounded(1)),
                ...
                segment(s::DTP.use(1350, r::Situational, d::RepeatCount.bounded(1)),
                segment(s::DTP.use(1350, r::Situational, d::RepeatCount.bounded(1)),
                segment(s::DTP.use(1350, r::Situational, d::RepeatCount.bounded(2)),
                segment(s::DTP.use(1350, r::Situational, d::RepeatCount.bounded(1)),
                segment(s::DTP.use(1350, r::Situational, d::RepeatCount.bounded(1)),
                segment(s::PWK.use(1550, r::Situational, d::RepeatCount.bounded(10)),
                segment(s::CN1.use(1600, r::Situational, d::RepeatCount.bounded(1)),
                segment(s::AMT.use(1750, r::Situational, d::RepeatCount.bounded(1)),
                segment(s::REF.use(1800, r::Situational, d::RepeatCount.bounded(1)),
                segment(s::REF.use(1800, r::Situational, d::RepeatCount.bounded(1)),
                segment(s::REF.use(1800, r::Situational, d::RepeatCount.bounded(1)),
                segment(s::REF.use(1800, r::Situational, d::RepeatCount.bounded(1)),
                segment(s::REF.use(1800, r::Situational, d::RepeatCount.bounded(1)),
                ...
                segment(s::REF.use(1800, r::Situational, d::RepeatCount.bounded(1)),
                segment(s::REF.use(1800, r::Situational, d::RepeatCount.bounded(1)),
                segment(s:: K3.use(1850, r::Situational, d::RepeatCount.bounded(10)),
                segment(s::NTE.use(1900, r::Situational, d::RepeatCount.bounded(1)),
                segment(s::CR1.use(1950, r::Situational, d::RepeatCount.bounded(1)),
                segment(s::CR2.use(2000, r::Situational, d::RepeatCount.bounded(1)),
                segment(s::CRC.use(2200, r::Situational, d::RepeatCount.bounded(3)),
                segment(s::CRC.use(2200, r::Situational, d::RepeatCount.bounded(3)),
                segment(s::CRC.use(2200, r::Situational, d::RepeatCount.bounded(1)),
                segment(s::CRC.use(2200, r::Situational, d::RepeatCount.bounded(1)),
                segment(s:: HI.use(2310, r::Required, d::RepeatCount.bounded(1)),
                segment(s:: HI.use(2310, r::Situational, d::RepeatCount.bounded(1)),
                segment(s:: HI.use(2310, r::Situational, d::RepeatCount.bounded(1)),
                segment(s::HCP.use(2410, r::Situational, d::RepeatCount.bounded(1)),
