    ...
    module FiftyTen
      module Implementations
        module X223A3
          ...
          # According to the comment from Consolidated Guide for 005010X223. This loop is used in two cases.
          # Citing the document it says:
          #
          ...
          # Because of this the claim information is said to “float.” Claim information is positioned in the same
          # hierarchical level that describes its owner-participant, either the subscriber or the dependent. In other
          # words, the claim information, loop 2300, is placed following loop 2010BB in the subscriber hierarchical level
          # when the patient is the subscriber, or it is placed at the patient/dependent hierarchical level when the
          # patient is the dependent of the subscriber as shown here. When the patient is the subscriber, loops 2000C and
          # 2010CA are not sent. See 1.4.3.2.2.1, HL Segment, for details.
          loop2300 =
            d::LoopDef.build("2300 CLAIM INFORMATION",
              ...
              b::Segment(1350, s::DTP, "Admission Date/Hour",
                ...
                b::Element(e::Required,      "Admission Date/Hour or Start of Care Date")),
              ...
              b::Segment(2200, s::CRC, "EPSDT Referral",
                r::Situational, d::RepeatCount.bounded(1),
                b::Element(e::Required,    "Code Qualifier", b::Values("ZZ")),
                b::Element(e::Required,    "Certification Condition Code Applies Indicator", b::Values("Y", "N")),
                b::Element(e::Required,    "Condition Indicator", b::Values("AV", "NU", "S2", "ST")),
                b::Element(e::Situational, "Condition Indicator", b::Values("AV", "NU", "S2", "ST")),
                b::Element(e::Situational, "Condition Indicator", b::Values("AV", "NU", "S2", "ST")),
              ...
              d::LoopDef.build("2310A ATTENDING PROVIDER NAME",
                ...
                b::Segment(2710, s::REF, "Attending Provider Secondary Identification",
                  r::Situational, d::RepeatCount.bounded(4),
                  b::Element(e::Required,    "Reference Identification Qualifier", b::Values("0B", "1G", "G2", "LU")),
                  b::Element(e::Required,    "Attending Provider Secondary Identifier"),
                  b::Element(e::NotUsed,     "Description"),
                  b::Element(e::NotUsed,     "REFERENCE IDENTIFIER"))),
              ...
              d::LoopDef.build("2310B OPERATING PHYSICIAN NAME",
                ...
                b::Segment(2500, s::NM1, "Operating Physician Name",
                  ...
                  b::Element(e::NotUsed,     "Name Prefix"),
                  b::Element(e::Situational, "Operating Physician Name Suffix"),
                  b::Element(e::Situational, "Identification Code Qualifier", b::Values("XX")),
